...
int sumOfAllQuantitys = orderList.Sum(order => order.Quantity);
Console.WriteLine($"The sum is {sumOfAllQuantitys}");
...
Console.WriteLine("=======Orderde List: =======");
var orderOrderList = orderList.OrderBy(x=> x.Id).ToList();
orderOrderList.ForEach(x => Console.WriteLine(x));

Console.WriteLine("=======Orderde List Desc: =======");
var orderOrderListDesc = orderList.OrderByDescending(x => x.Id).ToList();
orderOrderListDesc.ForEach(x => Console.WriteLine(x));

Console.WriteLine("=======Orderde List string: =======");
var orderOrderListString = orderList.OrderByDescending(x => x.Id).ToList();
orderOrderListString.ForEach(x => Console.WriteLine(x));
...
{
    Console.WriteLine(orderGrouping);
